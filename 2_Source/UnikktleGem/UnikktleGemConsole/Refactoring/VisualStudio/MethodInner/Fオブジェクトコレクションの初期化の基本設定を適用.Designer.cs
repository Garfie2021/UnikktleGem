...
{
    partial class Fオブジェクトコレクションの初期化の基本設定を適用
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Fオブジェクトコレクションの初期化の基本設定を適用));
    ...
    "毎にチェックするのが望ましい。";
            ...
            this.Name = "Fオブジェクトコレクションの初期化の基本設定を適用";
